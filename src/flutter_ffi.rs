...
pub mod server_side {
    ...
    #[no_mangle]
    pub unsafe extern "system" fn Java_com_carriez_flutter_1MtLink_MainService_startServer(
        env: JNIEnv,
        _class: JClass,
        app_dir: JString,
    ) {
    ...
    #[no_mangle]
    pub unsafe extern "system" fn Java_com_carriez_flutter_1MtLink_MainService_startService(
        _env: JNIEnv,
        _class: JClass,
    ) {
    ...
    #[no_mangle]
    pub unsafe extern "system" fn Java_com_carriez_flutter_1MtLink_MainService_translateLocale(
        env: JNIEnv,
        _class: JClass,
        locale: JString,
        input: JString,
    ...
    #[no_mangle]
    pub unsafe extern "system" fn Java_com_carriez_flutter_1MtLink_MainService_refreshScreen(
        _env: JNIEnv,
        _class: JClass,
    ) {
